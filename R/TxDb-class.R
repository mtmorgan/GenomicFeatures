...
.get_TxDb_seqlevels0 <- function(x)
{
...
## THIS IS VERY BROKEN!!! (and is fixed in BioC 3.2)
...
setReplaceMethod("seqlevels", "TxDb",
    ...
    {
        x_seqlevels0 <- .get_TxDb_seqlevels0(x)  # the "real" seqlevels (i.e.
                                                 # from the db)
...
{
    txdb_seqlevels0 <- .get_TxDb_seqlevels0(txdb)
